...
class PlanesControllerTest < ActionController::TestCase
  ...
  test "should create plane" do
    assert_difference('Plane.count') do
      post :create, plane: { category: @plane.category, name: @plane.name, specifications: @plane.specifications }
    end
  ...
  test "should update plane" do
    put :update, id: @plane, plane: { category: @plane.category, name: @plane.name, specifications: @plane.specifications }
    assert_response 204
  end
